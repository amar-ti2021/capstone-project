            ...
            <section className="bg-center bg-gradient-to-b from-bright-blue to-pale-blue">
                <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
                    ...
                    <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                        <a href="#product" className="inline-flex justify-center items-center py-3 px-5 text-base font-inter font-medium text-center text-white rounded-lg bg-moderate-blue hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                            Get started
