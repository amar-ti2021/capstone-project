...
const OurTeam = () => {
    return (
        <div id="our-team" className="flex flex-col items-center bg-gradient-to-b from-bright-blue to-pale-blue min-h-screen py-12">
            <h1 className="text-4xl text-white drop-shadow-md font-frank font-bold mb-12">Our Team</h1>
