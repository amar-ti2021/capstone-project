...
const Statistic = () => {
    ...
    return (
        <div>
            ...
            <div className="w-full h-screen bg-gradient-to-b from-bright-blue to-soft-blue2 shadow dark:bg-gray-800 p-10 md:px-10 md:pt-10">
                <div className="flex justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex items-center">
                        ...
                        <div>
                            <h5 className="leading-none text-2xl font-bold text-white pb-1">Stress Management</h5>
                ...
                <center>
                    <div id="column-chart" className='max-w-lg'></div>
                </center>
            ...
            <footer className="bg-gradient-to-b from-soft-blue2 to-soft-blue3 pt-7 pb-10 md:p-10 xl:p-10">
